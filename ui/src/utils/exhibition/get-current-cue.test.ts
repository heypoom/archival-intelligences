...
export const DEMO_SEQ: AutomationCue[] = [
  {time: '00:01:00', action: 'prompt', prompt: 'b', program: ''},
...
const cases: [string, AutomationCue | undefined][] = [
  ['00:00:59', undefined],
  ['00:01:00', {time: '00:01:00', action: 'prompt', prompt: 'b', program: ''}],
  ['00:01:59', {time: '00:01:00', action: 'prompt', prompt: 'b', program: ''}],
