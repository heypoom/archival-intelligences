...
class Inference:
    ...
    def load_lora(self, repo: str, name: str):
        print("Loading LORA weights...")
        self.pipe.load_lora_weights(repo, weight_name=name, token=os.environ["HF_TOKEN"])
    ...
    def run(
        ...
        self.load_lora(lora_repo, lora_name)
